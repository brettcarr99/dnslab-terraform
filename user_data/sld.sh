#!/bin/bash
# Terraform template vars: sld_ip=${sld_ip}
set -euo pipefail
...
; Test records — edit these to experiment with the lab
...
chown named:named /var/named/example.lab.zone
chmod 640 /var/named/example.lab.zone
